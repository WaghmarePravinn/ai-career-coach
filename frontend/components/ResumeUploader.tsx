      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-center space-y-2">
          <h3 className="text-2xl font-bold tracking-tight text-white">
            {isUploading ? "Processing Knowledge..." : result ? "Analysis Complete" : "Analyze Your Resume"}
          </h3>
          <p className="text-slate-400 text-sm max-w-[280px] mx-auto">
            Our AI agents will deconstruct your experience into semantic vector embeddings.
          </p>
        </div>
        ...
        {result && (
          <div className="w-full p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2">
            ...
            <div className="text-sm text-emerald-100">
              <p className="font-bold">Resume Indexed!</p>
              <p className="opacity-80">AI generated <strong>{result.chunks}</strong> knowledge chunks for your profile.</p>
            </div>
          </div>
        )}
